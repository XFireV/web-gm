...
<body>
    ...
    <div id="auth-modal" class="modal">
        <div class="modal-content">
            <h2>Bem-vindo ao RPG Multijogador!</h2>
            <div id="login-form">
                <h3>Fazer Login</h3>
                <input type="text" id="login-username" placeholder="Nome de usuário" maxlength="20">
                <input type="password" id="login-password" placeholder="Senha" maxlength="50">
                <button id="login-button">Entrar</button>
                <p>Não tem uma conta? <a href="#" id="show-register">Criar conta</a></p>
            </div>
            <div id="register-form" class="hidden">
                <h3>Criar Conta</h3>
                <input type="text" id="register-username" placeholder="Nome de usuário" maxlength="20">
                <input type="password" id="register-password" placeholder="Senha" maxlength="50">
                <input type="password" id="register-confirm-password" placeholder="Confirmar senha" maxlength="50">
                <div class="color-picker">
                    <label>Cor da sua bola de viagem:</label>
                    <input type="color" id="travel-ball-color" value="#ff0000">
                </div>
    ...
    <div class="game-container">
        <div id="world-status-display">
            ...
            <div><strong>Horário:</strong> <span id="world-time">00:00</span></div>
        </div>
        ...
        <div id="map-area" class="game-section full-screen">
            ...
            <div id="global-chat" class="chat-container">
                ...
                <div id="chat-input-container">
                    <input type="text" id="chat-input" placeholder="Digite sua mensagem..." maxlength="200">
                    <button id="send-chat">Enviar</button>
                </div>
            </div>
            
            <!-- Sistema de Viagem com Bolas dos Jogadores -->
            <div id="travel-balls-container"></div>
            
            <!-- Setas de Direção -->
            <div id="direction-arrows-container"></div>
        </div>
        ...
        <div id="location-modal" class="modal hidden">
            <div class="modal-content">
                ...
                <div class="location-actions">
                    ...
                    <button id="capital-upgrade-button" class="hidden">Aprimorar Capital</button>
        ...
        <div id="capital-upgrade-modal" class="modal hidden">
            <div class="modal-content">
                <span class="close-button" data-modal="capital-upgrade">&times;</span>
                <h2>Aprimorar Capital</h2>
                <div id="capital-upgrade-details">
                    <h3 id="capital-upgrade-name">Capital</h3>
                    <p>Nível Atual: <span id="current-capital-level">0</span></p>
                    <p>Nível Desejado: <span id="target-capital-level">1</span></p>
                    <div id="upgrade-requirements">
                        <h4>Requisitos para o Próximo Nível:</h4>
                        <ul id="upgrade-requirements-list"></ul>
                    </div>
                    <div id="upgrade-benefits">
                        <h4>Benefícios do Próximo Nível:</h4>
                        <ul id="upgrade-benefits-list"></ul>
                    </div>
                </div>
                <div class="capital-upgrade-actions">
                    <button id="request-upgrade-button">Solicitar Aprimoramento</button>
                    <button id="cancel-upgrade-button">Cancelar</button>
                </div>
            </div>
        </div>

        <div id="farm-choice-modal" class="modal hidden">
            <div class="modal-content">
                <span class="close-button" data-modal="farm-choice">&times;</span>
                <h2 id="farm-choice-title">Escolha sua Atividade</h2>
                <div id="farm-choice-description"></div>
                <div class="farm-choice-actions">
                    <button id="active-farm-choice-button">Farm Ativo</button>
                    <button id="passive-farm-choice-button">Farm Passivo</button>
                    <button id="exit-location-button">Sair do Local</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content info-panel-content">
                ...
                <div class="info-panel-container">
                    <div class="info-tabs">
                        ...
                        <button class="info-tab-button" data-tab="economy-info">Economia</button>
                    </div>
                    <div id="world-info-tab" class="info-tab-content active">
                        ...
                        <div class="info-categories">
                            ...
                            <div class="info-category">
                                <h3 class="expandable-header" data-category="cities">Cidades <span class="expand-icon">+</span></h3>
                                <div class="category-content hidden" id="cities-content"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="economy-info-tab" class="info-tab-content">
                        <h2>Informações Econômicas</h2>
                        <div id="economy-content-display">
                            <div id="capital-economy-info">
                                <h3>Economia das Capitais</h3>
                                <div id="capital-economy-list"></div>
                            </div>
                            <div id="capital-upgrade-info" class="hidden">
                                <h3>Aprimoramento de Capital</h3>
                                <div id="capital-upgrade-status"></div>
                                <div id="capital-upgrade-contribution">
                                    <h4>Contribuir para o Aprimoramento</h4>
                                    <div class="contribution-inputs">
                                        <label>Ouro: <input type="number" id="contribution-gold" min="0" value="0"></label>
                                        <label>Recursos: <input type="number" id="contribution-resources" min="0" value="0"></label>
                                        <button id="contribute-button">Contribuir</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Modal de Jogadores Online (Tecla P) -->
    <div id="players-modal" class="modal hidden">
        <div class="modal-content info-panel-content">
            <span class="close-button" data-modal="players">&times;</span>
            <div class="info-panel-container">
                <div class="info-tabs">
                    <button class="info-tab-button active" data-tab="players-list">Jogadores</button>
                    <button class="info-tab-button" data-tab="private-chat">Privado</button>
                    <button class="info-tab-button" data-tab="guild-chat">Guilda</button>
                    <button class="info-tab-button" data-tab="global-chat-tab">Global</button>
                    <button class="info-tab-button" data-tab="server-info">Servidor</button>
                </div>
                <div id="players-list-tab" class="info-tab-content active">
                    <h2>Jogadores Online</h2>
                    <div id="online-players-list"></div>
                </div>
                <div id="private-chat-tab" class="info-tab-content">
                    <h2>Chat Privado</h2>
                    <div id="private-chat-messages"></div>
                    <div id="private-chat-input">
                        <input type="text" id="private-message-input" placeholder="Digite sua mensagem privada..." maxlength="200">
                        <button id="send-private-message">Enviar</button>
                    </div>
                </div>
                <div id="guild-chat-tab" class="info-tab-content">
                    <h2>Chat da Guilda</h2>
                    <div id="guild-chat-messages"></div>
                    <div id="guild-chat-input">
                        <input type="text" id="guild-message-input" placeholder="Digite sua mensagem para a guilda..." maxlength="200">
                        <button id="send-guild-message">Enviar</button>
                    </div>
                </div>
                <div id="global-chat-tab" class="info-tab-content">
                    <h2>Chat Global</h2>
                    <div id="global-chat-messages-tab"></div>
                </div>
                <div id="server-info-tab" class="info-tab-content">
                    <h2>Informações do Servidor</h2>
                    <div id="server-info-content">
                        <p><strong>Jogadores Online:</strong> <span id="server-players-count">0</span></p>
                        <p><strong>Guildas Ativas:</strong> <span id="server-guilds-count">0</span></p>
                        <p><strong>Eventos Ativos:</strong> <span id="server-events-count">0</span></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Modal de Sistema de Venda (Tecla L) -->
    <div id="market-modal" class="modal hidden">
        <div class="modal-content">
            <span class="close-button" data-modal="market">&times;</span>
            <h2>Mercado de Jogadores</h2>
            <div class="market-tabs">
                <button class="market-tab-button active" data-tab="my-listings">Meus Itens</button>
                <button class="market-tab-button" data-tab="buy-items">Comprar Itens</button>
            </div>
            <div id="my-listings-tab" class="market-tab-content active">
                <h3>Meus Itens à Venda</h3>
                <div id="my-listings-container"></div>
                <div class="add-listing-form">
                    <h4>Adicionar Item à Venda</h4>
                    <select id="item-to-sell">
                        <option value="">Selecione um item</option>
                    </select>
                    <input type="number" id="item-quantity" placeholder="Quantidade" min="1" value="1">
                    <input type="number" id="item-price" placeholder="Preço em ouro" min="1" value="1">
                    <button id="add-listing-button">Adicionar à Venda</button>
                </div>
            </div>
            <div id="buy-items-tab" class="market-tab-content">
                <h3>Itens à Venda por Outros Jogadores</h3>
